...
5. STRICT OUTPUT FORMAT: You must ONLY output the JSON dict under the "Path:" field. Do NOT include any extra content such as explanations, comments, parentheses (e.g., (i.e., ...)), or redundant punctuation. The JSON must be valid and parsable by Python's json.loads() function.
