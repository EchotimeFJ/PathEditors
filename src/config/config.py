...
# Token rates for different LLM models (in USD per 1k tokens)
TOKEN_RATES = {
    'gpt-3.5-turbo': {'input': 0.001, 'output': 0.002},
    'gpt-4-turbo': {'input': 0.015, 'output': 0.045},
    'gpt-4o': {'input': 0.003, 'output': 0.01},
    'deepseek-r1': {'input': 0.004, 'output': 0.016},
    'deepseek-v3': {'input': 0.002, 'output': 0.008},
    'llama-2-70b': {'input': 0.002, 'output': 0.002},
    'gpt-5': {'input': 0.001, 'output': 0.01},
}
